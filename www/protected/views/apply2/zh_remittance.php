				...
				'htmlOptions'=>array(
                    ...
                    <div class="paymentList">
                        ...
                        <div class="greenbox longStyle">
                            ...
                            <div class="discrition">提醒：請確保匯出款項以另加上銀行轉帳費，匯款入帳金額應為以上實際相同金額。</div>
                            <h2> NTD <?=number_format($model->pay_total);?></h2>
                        </div>
                    </div>
                    -->
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <th>填寫付款資訊<span style="color:red;">*<span><br>
                                    <div class="small-text">所有欄位爲必填</div>
                                </th>
                                <td class="control-group">
                                    <label>戶名</label>
                                    <div class="controls">
                                        <?php echo CHtml::activeTextField($model,'paybank_name2',$htmlOptions = array('class'=>'form','ng-model'=>'data.paybank_name2','ng-required'=>'true','parsley-trigger'=>"change",'data-parsley-required-message'=>"此欄爲必填")); ?>
                                        <!-- 姓名驗證 -->
                            ...
                            <tr>
                                ...
                                <td class="control-group">
                                    <label>付款銀行</label>
                                    <div class="controls">
                                        <?php echo CHtml::activeTextField($model,'paybank_bank2',$htmlOptions = array('class'=>'form','ng-model'=>'data.paybank_bank2','ng-required'=>'true','parsley-trigger'=>"change",'data-parsley-required-message'=>"此欄爲必填")); ?>
                                        <!-- 銀行驗證 -->
                                        <div class="parsley-errors-list filled">
                                ...
                                <td class="control-group">
                                    <label>帳戶號碼</label>
                                    <div class="controls">
                                        <?php echo CHtml::activeTextField($model,'paybank_account2',$htmlOptions = array('class'=>'form','ng-model'=>'data.paybank_account2','ng-required'=>'true','parsley-trigger'=>"change",'data-parsley-required-message'=>"此欄爲必填")); ?>
                                        <!-- 銀行驗證 -->
                                        <div class="parsley-errors-list filled">
                        ...
                        <tbody>
                            <tr>
                                <th>填寫退款資訊<span style="color:red;">*<span><br>
                                    <div class="small-text">所有欄位爲必填</div>
                                </th>
                                <td class="control-group">
                                    <label>戶名</label>
                                    <div class="controls">
                                        <?php echo CHtml::activeTextField($model,'returnbank_name2',$htmlOptions = array('class'=>'form','ng-model'=>'data.returnbank_name2','ng-required'=>'true','parsley-trigger'=>"change",'data-parsley-required-message'=>"此欄爲必填")); ?>
                                        <!-- 姓名驗證 -->
                                        <div class="parsley-errors-list filled">
                            ...
                            <tr>
                                ...
                                <td class="control-group">
                                    <label>退款銀行</label>
                                    <div class="controls">
                                        <?php echo CHtml::activeTextField($model,'returnbank_bank2',$htmlOptions = array('class'=>'form','ng-model'=>'data.returnbank_bank2','ng-required'=>'true','parsley-trigger'=>"change",'data-parsley-required-message'=>"此欄爲必填")); ?>
                                        <!-- 銀行驗證 -->
                                        <div class="parsley-errors-list filled">
                                ...
                                <td class="control-group">
                                    <label>帳戶號碼</label>
                                    <div class="controls">
                                        <?php echo CHtml::activeTextField($model,'returnbank_account2',$htmlOptions = array('class'=>'form','ng-model'=>'data.returnbank_account2','ng-required'=>'true','parsley-trigger'=>"change",'data-parsley-required-message'=>"此欄爲必填")); ?>
                                        <!-- 銀行驗證 -->
                                        <div class="parsley-errors-list filled">
                    ...
                    <div class="btn-group">
                        <button class="btn-green inlin-blk" type="button" ng-click="submitted(myForm.$valid);" >確認完成</button>
                    </div>
            <?php $this->endWidget(); ?>
        </div>
    <script>
