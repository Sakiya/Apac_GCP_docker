                    ...
                    <div class="login-box" ng-app="validator" ng-controller="forgetController">
                        ...
                        <?php echo CHtml::beginForm('/' . Yii::app()->language . '/member/forgetAsyn/', 'post', array('role'=>'form','name'=>'myForm','id'=>'myForm', 'novalidate'=>true)) ; ?>
                            <fieldset>
                                ...
                                <!-- <input type="email" class="email form" name="ForgetForm[email]" placeholder="Email" ng-model="user.email" ng-required="true" > -->
                                ...
                                <div style="display:inline-box;">
                                    ...
                                    <?php $this->widget('CCaptcha', array('captchaAction'=>'member/captcha', 'imageOptions'=>array('id'=>'captchaImage','style'=>'vertical-align: middle;margin-right: 5px;'), 'buttonLabel'=>'新驗證碼', 'buttonOptions'=>array('class'=>'font11'))); ?>
                                </div>
            ...
            validator.controller('forgetController', ['$scope', function($scope) {
                ...
                $scope.register = function() {
                    ...
                    if(!$scope.disSubmitBtn){
                        ...
                        $.post(
                            '/zh/member/forgetAsyn',
                            $('#myForm').serialize(),
                            function(xml){
                                var data = JSON.parse(xml);
                                if (data.status == 'success'){
                                    alert(data.message);
                                    window.location.href = '/zh/Member/index';
                                }else{
                                    alert(data.message);
                                }
                                // $scope.disSubmitBtn = false;
