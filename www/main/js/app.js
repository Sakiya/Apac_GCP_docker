    ...
    var t = {
        ...
        listenInput: function() {
            $(".zh .file-upload-native").on("change", function() {
                    ...
                    if (_size <= 1 & (_type== 'image/jpg' || _type== 'image/jpeg' || _type== 'image/png')){
            ...
            $(".en .file-upload-native").on("change", function() {
                    ...
                    var _type = this.files[0].type;
                    if (_size <= 1 & (_type== 'image/jpg' || _type== 'image/jpeg' || _type== 'image/png')){
                        t.setPreviewImg(this), $(this).siblings(".file-upload-text").text("Change Image"), $(this).parents(".upload").find(".delete-img").show()
                    }
            });
        }
