        ...
        <div class="right">
			...
			<?php $form=$this->beginWidget('CActiveForm', array(
				...
				'htmlOptions'=>array(
                    ...
                    <div class="title">上傳行銷活動可使用圖檔（非必填)</div>
                    <h5>限為本屆展出藝術家之作品，圖檔將作爲網站宣傳等行銷使用。建議可特別註記作品特色及亮點，例: 名家小品典藏、上過拍場的藝術家作品、首次曝光作品、首次參加藝博會的藝術家...等，限提供十件作品。</h5>
                    <div class="applyOAA">
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <th></th>
                                        <td colson="2">
                                            <label>作品預覽圖檔上傳<span>*</span></label>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" class="control-group">
                                            <label>特別說明</label>
                                            <div class="controls">
                                                <?php echo CHtml::activeTextArea($Work, '[{{$index}}]content1', array('class'=>'form','ng-model'=>"item.content1",'style'=>'width: 100%;','style'=>'width: 100%;','maxlength'=>1200,'placeholder'=>'名家小品典藏、限量版次作品、上過拍場的藝術家作品、首次曝光作品、首次參加藝博會的藝術家...等'));?>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <div class="addAppyBox" ng-click="model.campuses.add()" ng-hide="model.campuses.length >= 10">
                            <div>
                                ...
                                <div class="text">新增其他行銷可使用圖檔</div>
                            </div>
                        </div>
                    </div>
                    <div class="btn-group"> 
                        <a class="btn-green-border" href="<?=$this->createUrl('/apply2/usd300/',array('language'=>Yii::app()->language))?>">回上一單元修改資料</a>
                        <a ng-show="model.campuses.length <= 0" class="btn-green-bg" href="<?=$this->createUrl('/apply2/Marketing_next/',array('language'=>Yii::app()->language))?>">略過</a>
