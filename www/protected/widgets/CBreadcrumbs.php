...
class CBreadcrumbs extends CWidget
{
	 ...
	 */
	public $htmlOptions=array('class'=>'breadcrumbs clearfix','itemscope'=>'','itemtype'=>'http://schema.org/BreadcrumbList');
	/**
	...
	public $activeLinkTemplate='<li property="itemListElement" typeof="ListItem" itemtype="http://schema.org/ListItem" ><a property="item" href="{url}" title="{label}" >{label}</a> <meta property="position" content="{sort}"></li>';
	/**
	...
	public $inactiveLinkTemplate='<li property="itemListElement" typeof="ListItem" itemtype="http://schema.org/ListItem" class="active"><a property="item" >{label}</a> <meta property="position" content="{sort}"></li>';
	/**
