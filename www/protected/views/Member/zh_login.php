                ...
                <div class="right col-sm-6">
                    <div class="login-box" ng-app="validator" ng-controller="loginController">
						...
						<?php echo $form->hiddenField($model,'year',$htmlOptions = array('value'=>$this->Year->Yearm1_no)); ?>
                            <fieldset>
						        <?php echo $form->emailField($model,'email',$htmlOptions = array('class'=>'email form form2','placeholder'=>'Email','ng-model'=>'user.email','ng-required'=>'true','placeholder'=>'Email')); ?>
								...
								<?php echo $form->passwordField($model,'password',$htmlOptions = array('class'=>'password form form2','placeholder'=>'Email','ng-model'=>'user.password','ng-required'=>'true','placeholder'=>'Password')); ?>
