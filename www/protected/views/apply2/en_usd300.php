        ...
        <div class="right">
			...
			<?php $form=$this->beginWidget('CActiveForm', array(
				...
				'htmlOptions'=>array(
                    ...
                    <div class="title">Campaign Activity - Best Buy 3,000 USD (Not Compulsory)</div>
                    <h5><!-- ”Best Buy 3,000 USD收藏入門活動“是由ONE ART Taipei 2019參展畫廊推薦一件價值於五千美金以下的優質作品，負擔得起的價格讓喜愛當代藝術的入門藏家走進收藏世界，替臧家們聚集這些亮點作品，花最短的時間走進藝術投資與收藏的市場。也請您務必於<?=(new DateTime($this->Year->Yearm1_open2ed))->format('Y/m/d');?>前回覆貴畫廊推薦的作品之相關資訊。 -->
                        Best Buy 3,000 USD is designed to encourage new art collectors get into current art market in an accessible way. All participated galleries can nominate three artwork priced under USD$3,000.Skip if you’re not interested in participating this campaign.
                    </h5>
                    <div class="applyOAA">
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <th></th>
                                        <td colson="2">
                                            <label>Selected Competition Work<span>*</span></label>
                    ...
                    <div class="btn-group"> 
                        <a class="btn-green-border" href="<?=$this->createUrl('/apply2/award/',array('language'=>Yii::app()->language))?>">Go back to previous page</a>
                        <a ng-show="model.campuses.length <= 0" class="btn-green-bg" href="<?=$this->createUrl('/apply2/usd300_next/',array('language'=>Yii::app()->language))?>">Skip</a>
                        <button ng-show="model.campuses.length > 0" class="btn-green inlin-blk" type="button" ng-click="register(myForm.$valid);">Save and Next</button>
                    </div>
